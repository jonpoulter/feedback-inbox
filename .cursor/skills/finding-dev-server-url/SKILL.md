...
- `last_command` — what's running (e.g. `npm run dev`, `pnpm dev`, `python manage.py runserver`, `uvicorn app.main:app --reload --port 8000`)
...
| FastAPI / Uvicorn | `Uvicorn running on http://127.0.0.1:XXXX` |
...
- Common default ports: Next.js (3000), Vite (5173), FastAPI/Uvicorn (8000), Django (8000), Rails (3000), Flask (5000), Go (8080)
